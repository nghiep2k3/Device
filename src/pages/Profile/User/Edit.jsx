    ...
    return (
        ...
        <div>
            ...
            <Col span={8}>
                ...
                >
                <Input className={styles.inputc} defaultValue="Minh Quang Tran" />
            </Form.Item>
            </Col>
            <Col span={8}>
                <Form.Item
                    ...
                    >
                    <Input className={styles.inputc} defaultValue="abc.ab@gmail.com"/>
                </Form.Item>
            </Col>
            <Col span={8}>
                <Form.Item
                    ...
                    >
                    <Input className={styles.inputc} defaultValue="super.admin" />
                </Form.Item>
            </Col>
            </Row>
            <Row>
            <Col span={8}>
                ...
                >
                <Input.Password className={styles.inputc} defaultValue="Enter owner password" />
            </Form.Item>
            </Col>
            <Col span={8}>
                <Form.Item
                    ...
                    >
                    <Input className={styles.inputc} defaultValue="0912 234 456"/>
                </Form.Item>
            </Col>
            <Col span={8}>
                <Form.Item
                    ...
                    >
                    <Select className={styles.inputc} size='large' defaultValue="Male">
            ...
            <Col span={8}>
                <Form.Item
                    ...
                    >
                    <Select className={styles.inputc} size='large' defaultValue="Admin">
            ...
            <Col span={8}>
                <Form.Item
                    ...
                    >
                    <Select className={styles.inputc} size='large' defaultValue="Active">
